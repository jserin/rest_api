    ...
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests((authorizeHttpRequests) -> authorizeHttpRequests
                        .requestMatchers(new AntPathRequestMatcher("/api/*/member/login")).permitAll()// 로그인은 누구나 가능
                        .requestMatchers(new AntPathRequestMatcher("/api/*/articles")).permitAll()// 글 보기는 누구나 가능
